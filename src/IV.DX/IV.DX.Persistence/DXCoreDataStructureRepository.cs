...
namespace IV.DX.Persistence
{
    internal static class DXCoreDataStructureRepository
    {
        ...
        private static void InitCoreEnumInfos()
        {
            ...
            var dxElementInUnitTypeEnum = new DXEnumDefinitionUnit()
            {
            ...
            var dxColumnTypeEnum = new DXEnumDefinitionUnit()
            {
            ...
            var dxObjectKindEnum = new DXEnumDefinitionUnit()
            {
        ...
        private static void InitCoreDXElementInfos()
        {
            ...
            var DXObjectDefinitionMainElement = new DXElementDefinitionUnit()
            {
            ...
            var DXElementInUnitDefinitionElement = new DXElementDefinitionUnit()
            {
