...
namespace IV.DX.Persistence
{
    internal static class CoreDataStructureRepository
    {
        ...
        private static void InitCoreEnumInfos()
        {
            ...
            var dpBlockInObjectTypeEnum = new DXEnumDefinitionUnit()
            {
            ...
            var dpColumnTypeEnum = new DXEnumDefinitionUnit()
            {
            ...
            var dpObjectKindEnum = new DXEnumDefinitionUnit()
            {
            ...
            CoreEnumInfos = new List<DXEnumDefinitionUnit>()
            {
        ...
        private static void InitCoreBlockInfos()
        {
            ...
            var dpObjectDescGenBlock = new DXElementDefinitionUnit()
            {
            ...
            var DXColumnDefinitionElement = new DXElementDefinitionUnit()
            {
            ...
            var dpBlockInEntityDescGenBlock = new DXElementDefinitionUnit()
            {
        ...
        private static void InitCoreEntityInfos()
        {
            ...
            var dpObjectDescObject = new DXUnitDefinitionUnit()
            {
            ...
            var DXUnitDefinitionUnit = new DXUnitDefinitionUnit()
            {
            ...
            var DXElementDefinitionUnit = new DXUnitDefinitionUnit()
            {
            ...
            var DXEnumDefinitionUnit = new DXUnitDefinitionUnit()
            {
