...
namespace IV.DX.Application.Contracts.Abstractions
{
    public interface IDXUnitDataService
    {
        ...
        Task<IEnumerable<T>> GetItemsAsync<T>(string dxsqlWhereExpression, IDXHandlerContext? context = default, DXLoadingType typeOfLoading = DXLoadingType.Full, CancellationToken ct = default) where T : DXUnit, new();
        ...
        Task<IEnumerable<JObject>> GetItemsAsync(string typeName, string dxsqlWhereExpression, IDXHandlerContext? context = default, CancellationToken ct = default);
