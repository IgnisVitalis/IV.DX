...
namespace IV.DX.Persistence.IntTests.SQLQueryHelpers
{
    ...
    public class SQLQueryHelperTests : IntTestController
    {
        ...
        string tableAlias_TPassportMainElement_0 = "T_21_0";//TPassportMainElement
        string tableAlias_TPositionMainElement_0 = "T_22_0";//TPositionMainElement
        string tableAlias_TUserMainElement_0 = "T_23_0";//TUserMainElement
        string tableAlias_TDeviceMainElement_0 = "T_24_0";//TDeviceMainElement
        string tableAlias_TBookMainElement_0 = "T_25_0";//TBookMainElement
