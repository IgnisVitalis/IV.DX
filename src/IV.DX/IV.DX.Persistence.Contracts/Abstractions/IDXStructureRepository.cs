...
namespace IV.DX.Persistence.Contracts.Abstractions
{
    internal interface IDXStructureRepository
    {
        ...
        void ProcessUniqueColumns(string dxObjectName, IEnumerable<string[]> uniqueColumnsToAdd, IEnumerable<string[]> uniqueColumnsToRemove);
        ...
        void UpdateColumnValue(string tableName, string columnName, object value, Guid id);
        void UpdateColumnValue(string tableName, string columnName, object value, IDictionary<string, object> whereConditions);
        void SetColumnNotNull(string tableName, string columnName);
    }
}