...
namespace IV.DX.Application.DataHandlers
{
    internal class DXElementDefinitionUnitHandlerOld : DXObjectDefinitionUnitHandlerOld<DXElementDefinitionUnit>
    {
        ...
        public override Guid OnInserting(DXElementDefinitionUnit entity, DXUnitHandlerBaseContextOld context)
        {
        ...
        public override Guid OnUpdating(DXElementDefinitionUnit entity, DXUnitHandlerBaseContextOld context)
        {
            base.Validate(entity);
            base.Process(entity);
